...
Links:
* [Staging model in UC](https://dbc-89a0972b-a6bb.cloud.databricks.com/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://dbc-89a0972b-a6bb.cloud.databricks.com/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
